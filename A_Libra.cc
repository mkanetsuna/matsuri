...
Left
左の皿の上のおもりの重さの合計は 11 、
右の皿の上のおもりの重さの合計は 8 です。
11>8 なので、Left を出力します。
...
Balanced
左の皿の上のおもりの重さの合計は 7 、
右の皿の上のおもりの重さの合計は 7 です。
7=7 なので、Balanced を出力します。
...
Right
左の皿の上のおもりの重さの合計は 8 、
右の皿の上のおもりの重さの合計は 10 です。
8<10 なので、Right を出力します。
*/
#include <bits/stdc++.h>
